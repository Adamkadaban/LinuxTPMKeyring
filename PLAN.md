...
- [x] `cargo vet` supply-chain audit set imported (Mozilla/Google/etc.); exemptions bootstrap — full `safe-to-deploy` certification of `tss-esapi`/`secret-service` deferred (still `audit`/`deny`-gated)
